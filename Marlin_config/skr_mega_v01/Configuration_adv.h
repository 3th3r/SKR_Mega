...
//#define ENDSTOPS_ALWAYS_ON_DEFAULT /// homing safety, disable endstop
...
//#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 1.5    // Unit: mm compression per 1mm/s extruder speed // previous K value 1.5
